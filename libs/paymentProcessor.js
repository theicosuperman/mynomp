...
*/
    ...
    // network stats caching0 every 15 seconds
    ...
    // check operation statuses every 30  seconds
    var opid_interval = 30 * 1000;
    // shielding not required for some equihash coins
                ...
                daemon.batchCmd(batchRPCcommand, function (error, txDetails) {
                    ...
                    txDetails.forEach(function (tx, i) {
                        ...
                        // update confirmations for round
                        		console.log("PaymentProcessor.js, tx.result.confirmations = " + JSON.stringify(tx.result));
